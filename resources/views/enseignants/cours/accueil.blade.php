...
<div class="page-left">
    ...
    <div class="img-cours mt-5">
        <img src="{{ asset('img/1580009.jpg') }}" alt="">
        <img src="{{ asset('img/login.jpg') }}" alt="">
        <img src="{{ asset('img/18671.jpg') }}" alt="">
    </div>
    <div class="titre-cours my-5">
...
<div class="page-right">
    <a href="#" id="right-a" class="btn btn-outline-default mt-3">Le flux de cours</a>
    <a href="#" id="right-a" class="btn btn-outline-default mt-3">Le calendrier du cours</a>
    <a href="#" id="right-a" class="btn btn-outline-default mt-3">Les notifications des cours</a>
    <h2>Faire</h2>
